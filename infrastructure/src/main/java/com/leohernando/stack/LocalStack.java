...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        FargateService authService =
                createFargateService("AuthService", "auth-service",
                        List.of(4005),
                        authServiceDb,
                        Map.of("JWT_SECRET", "OzyeLeA7vmoxe27eS6W4my9Fk4RXTHSI2fbDEQVi048="));
        ...
        FargateService memberService =
                createFargateService("MemberService",
                        "member-service",
                        List.of(4000),
                        memberServiceDb,
                        Map.of(
    ...
    private Vpc createVpc() {
        return Vpc.Builder.create(this, "MemberManagementVPC")
                .vpcName("MemberManagementVPC")
                .maxAzs(2)
                .build();
    }
    ...
    private Cluster createEcsCluster() {
        return Cluster.Builder.create(this, "MemberManagementCluster")
                .vpc(vpc)
                .defaultCloudMapNamespace(CloudMapNamespaceOptions.builder()
                        .name("member-management.local")
                        .build())
                .build();
    }
